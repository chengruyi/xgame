...
public class XgameThreadFactory implements ThreadFactory {
	...
	public XgameThreadFactory() {
		this("x-game", false);
	}

	public XgameThreadFactory(String threadName) {
		this(threadName, false);
	}

	public XgameThreadFactory(String threadName, boolean daemon) {
		if (threadName == null) {
	...
	public static ThreadFactory createThreadFactory(String threadName, boolean daemon) {
		return new XgameThreadFactory(threadName, daemon);
	}
}
